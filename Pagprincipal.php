          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="productosDropdown">
              <li class="dropdown-submenu">
                <a class="dropdown-item dropdown-toggle" href="#" id="dropdown_celulares" role="button" data-bs-toggle="dropdown"
                aria-expanded="false">Celulares</a>
            ...
            <div class="col-md-4">
                ...
                <form>
                    <div class="input-group">
                        <input type="email" class="form-control" placeholder="Suscríbete a nuestra lista de correo" aria-label="Correo electrónico">
